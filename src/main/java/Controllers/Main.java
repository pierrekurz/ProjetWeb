...
public class Main {
	 public static void main(String[] args) throws Exception {
		...
		//CsvParser csvReader = new CsvParser("tab1","/Users/David/Desktop/yellow_tripdata_2015-08.csv");
		CsvParser csvReader = new CsvParser("parser", "yellow_tripdata_2009-01.csv");
